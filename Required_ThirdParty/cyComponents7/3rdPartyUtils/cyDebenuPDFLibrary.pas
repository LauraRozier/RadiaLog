...
uses Classes, DebenuPDFLibrary;

var DebenuLicenceKey: String;

function QuickPdf_ConvertPdf2Tif(SrcPdfFile, DestTifFile: String; Resolution: Integer): Boolean;
...
var
  ...
  SrcFicheiroPdf, DestFicheiro, Pages: String;
begin
  Result := false;
