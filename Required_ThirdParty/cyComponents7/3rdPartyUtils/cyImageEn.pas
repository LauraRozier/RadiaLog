...
uses Windows, Classes, SysUtils, imageenio, iemio, iewia, imscan, iexAcquire, iemview;
...
function ConvertTiffToTIFFG4FAX(SrcFileTIF, DestFileTIF: String; var Modified: Boolean): Boolean;
