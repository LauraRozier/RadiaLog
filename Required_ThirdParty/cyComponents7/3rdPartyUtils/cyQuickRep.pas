...
type
  ...
  function Qr_mmToPixels(aQuickRep: TQuickRep; mmValue: Double): Integer;

  function Qr_PixelsToMm(aQuickRep: TQuickRep; pxValue: Integer): Double;
...
// Para converter mm em pixeis : QrNotaCorte.Height => QrNotaCorte.Page.Length
function Qr_mmToPixels(aQuickRep: TQuickRep; mmValue: Double): Integer;
begin
  Result := Round(aQuickRep.Height / aQuickRep.Page.Length * mmValue);
end;

// Para converter pixeis em mm : QrNotaCorte.Page.Length => QrNotaCorte.Height
function Qr_PixelsToMm(aQuickRep: TQuickRep; pxValue: Integer): Double;
begin
