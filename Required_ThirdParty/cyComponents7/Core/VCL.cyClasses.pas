...
type
  ...
  TcyIntegerList=class(TList)
    private
    function GetItemValue(Index: Integer): Integer;
    procedure SetItemValue(Index: Integer; const Value: Integer);
    protected
    public
      function Add(ItemValue: Integer): Integer;
      function Extract(ItemValue: Integer): Integer;
      function First: Integer;
      function IndexOf(ItemValue: Integer): Integer;
      procedure Insert(Index: Integer; ItemValue: Integer);
      function Last: Integer;
      function Remove(ItemValue: Integer): Integer;
      property Items[Index: Integer]: Integer read GetItemValue write SetItemValue; default;
      procedure Sort;
    published
  end;
  ...
  // Use TDragImageList instead of Glyph:
...
function TcyIntegerList.Add(ItemValue: Integer): Integer;
begin
  Result := Inherited Add(Pointer(ItemValue));
end;

function TcyIntegerList.Extract(ItemValue: Integer): Integer;
begin
  Result := Integer( Inherited Extract(Pointer(ItemValue)) );
end;

function TcyIntegerList.First: Integer;
begin
  Result := Integer(Inherited First);
end;

function TcyIntegerList.GetItemValue(Index: Integer): Integer;
begin
  Result := Integer( Get(Index) );
end;

function TcyIntegerList.IndexOf(ItemValue: Integer): Integer;
begin
  Result := Inherited IndexOf(Pointer(ItemValue));
end;

procedure TcyIntegerList.Insert(Index, ItemValue: Integer);
begin
  Inherited Insert(Index, Pointer(ItemValue));
end;

function TcyIntegerList.Last: Integer;
begin
  Result := Integer(Inherited Last);
end;

function TcyIntegerList.Remove(ItemValue: Integer): Integer;
begin
  Result := Inherited Remove(Pointer(ItemValue));
end;

procedure TcyIntegerList.SetItemValue(Index: Integer; const Value: Integer);
begin
  Put(Index, Pointer(Value));
end;

procedure TcyIntegerList.Sort;
begin
...
destructor TcyGradient.Destroy;
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        cyGradientFill(aCanvas, aRect, FFromColor, FToColor, FOrientation, FBalance, FAngleDegree, FBalanceMode, FMaxDegrade, FSpeedPercent, FAngleClipRect, FAngleViewCache);
      ...
      cyGradientFill(aCanvas, aRect, FFromColor, FToColor, FOrientation, FBalance, FAngleDegree, FBalanceMode, FMaxDegrade, FSpeedPercent);
  end;
end;
...
procedure TcyImagelistOptions.SetImageList(const Value: TDragImageList);
begin
  FImageList := Value;
  if Assigned(FOnChange) then
    FOnChange(Self);
