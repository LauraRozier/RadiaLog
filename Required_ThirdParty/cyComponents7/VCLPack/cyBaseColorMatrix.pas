...
type
  ...
  protected
    ...
    procedure SetColorArrayItem(const aRow: Integer; const aCol: integer; const withColor: TColor);
    procedure SetColorArrayItemsRange(const fromRow, toRow, fromCol, toCol: Integer; const withColor: TColor);
    procedure SetColorArrayWithDefaultColor(const fromRow, fromCol: Integer);
  ...
  public
    ...
    procedure EndUpdate;
    procedure DrawText(const aText: String; const fromRow, fromCol, toRow, toCol: Integer; const TextFormat: LongInt);
    procedure DrawCanvas(const StartRow, StartColumn: Integer; Canvas: TCanvas; const CanvasRect: TRect; const TransparentColor: TColor; const Transparent: Boolean);
    procedure DrawGraphic(const StartRow, StartColumn: Integer; Graphic: TGraphic; const TransparentColor: TColor; const Transparent: Boolean);
    procedure LoadFromGraphic(aGraphic: TGraphic);
    procedure SaveToBitmap(Bitmap: TBitmap);
    function  FindCellColor(const fromRow, toRow, fromCol, toCol: Integer; const aColor: TColor; var aRow: Integer; var aCol: Integer): Boolean;
    function  GetCellAtPos(const aPoint: TPoint; var aRow: Integer; var aCol: Integer; const ExactPos: Boolean): Boolean;
    function  GetColumnPosition(const aCol: Integer): Integer;
    function  GetRowPosition(const aRow: Integer): Integer;
    function  GetColorGrid(const aRow: Integer; aCol: integer): TColor; virtual;
    procedure DrawCell(const CellRect: TRect; const CellColor: TColor; const Row, Column: Integer; const CustomDrawCell: Boolean);
    procedure DefaultDrawCell(aRect: TRect; const aRow, aCol: integer; const aColor: TColor);
    procedure ReplaceColor(const old, New: TColor); virtual;
    procedure SetColorGrid(const aRow: Integer; aCol: integer; const withColor: TColor);
    procedure SetColorGridRange(const fromRow, toRow, fromCol, toCol: Integer; const withColor: TColor);
    function RowToValue(const Row: Integer): Double;
    function ValueToRow(const Value: Double): Integer;
    function ColumnToValue(const Column: Integer): Double;
    function ValueToColumn(const Value: Double): Integer;
  published
  end;
...
procedure TcyBaseColorMatrix.SetColorArrayWithDefaultColor(const fromRow, fromCol: Integer);
var r, c: Integer;
begin
...
procedure TcyBaseColorMatrix.SetColorArrayItem(const aRow: Integer; const aCol: integer; const withColor: TColor);
begin
  if FColorArray[aCol, aRow] = withColor then Exit;
  FColorArray[aCol, aRow] := withColor;
end;

procedure TcyBaseColorMatrix.SetColorArrayItemsRange(const fromRow, toRow, fromCol, toCol: Integer; const withColor: TColor);
var r, c: Integer;
begin
...
function TcyBaseColorMatrix.GetColumnPosition(const aCol: Integer): Integer;
begin
  RESULT := GetBorderSize + (FCellWidth + FCellSpacingWidth) * aCol;
end;

function TcyBaseColorMatrix.GetRowPosition(const aRow: Integer): Integer;
begin
...
function  TcyBaseColorMatrix.GetCellAtPos(const aPoint: TPoint; var aRow: Integer; var aCol: Integer; const ExactPos: Boolean): Boolean;
var
...
function  TcyBaseColorMatrix.GetColorGrid(const aRow: Integer; aCol: integer): TColor;
begin
  RESULT := FColorArray[aCol, aRow];
end;

procedure TcyBaseColorMatrix.SetColorGrid(const aRow: Integer; aCol: integer; const withColor: TColor);
var
  CellRect: TRect;
  aLeft, aTop: Integer;
begin
...
procedure TcyBaseColorMatrix.SetColorGridRange(const fromRow, toRow, fromCol, toCol: Integer; const withColor: TColor);
var r, c: Integer;
begin
  for c := fromCol to toCol do
    for r := fromRow to toRow do
...
procedure TcyBaseColorMatrix.ReplaceColor(const old, New: TColor);
var
  CellRect: TRect;
  r, c: Integer;
  aLeft, aTop: Integer;
...
function TcyBaseColorMatrix.FindCellColor(const fromRow, toRow, fromCol, toCol: Integer; const aColor: TColor; var aRow, aCol: Integer): Boolean;
var r, c: Integer;
label found;
begin
  RESULT := false;
...
function TcyBaseColorMatrix.RowToValue(const Row: Integer): Double;
...
function TcyBaseColorMatrix.ValueToRow(const Value: Double): Integer;
var StepValue: Double;
begin
  StepValue := (BottomRowValue - TopRowValue) / (RowCount - 1);
...
function TcyBaseColorMatrix.ColumnToValue(const Column: Integer): Double;
var StepValue: Double;
begin
...
function TcyBaseColorMatrix.ValueToColumn(const Value: Double): Integer;
var StepValue: Double;
begin
  StepValue := (RightColumnValue - LeftColumnValue) / (ColCount - 1);
...
procedure TcyBaseColorMatrix.DrawCell(const CellRect: TRect; const CellColor: TColor; const Row, Column: Integer; const CustomDrawCell: Boolean);
begin
  if CustomDrawCell
...
procedure TcyBaseColorMatrix.DefaultDrawCell(aRect: TRect; const aRow, aCol: integer; const aColor: TColor);
begin
...
procedure TcyBaseColorMatrix.DrawCanvas(const StartRow, StartColumn: Integer; Canvas: TCanvas; const CanvasRect: TRect; const TransparentColor: TColor; const Transparent: Boolean);
var
...
procedure TcyBaseColorMatrix.DrawGraphic(const StartRow, StartColumn: Integer; Graphic: TGraphic; const TransparentColor: TColor; const Transparent: Boolean);
var
  r, c, BmpR, BmpC, EndRow, EndColumn: Integer;
  Bmp: TBitmap;
  BmpColor: TColor;
...
procedure TcyBaseColorMatrix.LoadFromGraphic(aGraphic: TGraphic);
begin
  DrawGraphic(0, 0, aGraphic, clNone, false);
end;
...
procedure TcyBaseColorMatrix.DrawText(const aText: String; const fromRow, fromCol, toRow, toCol: Integer; const TextFormat: LongInt);
var
  aBitmap: TBitmap;
  aRect: TRect;
begin
