...
procedure tcyBaseFlowPanel.AdjustClientRect(var Rect: TRect);
var w: Integer;
begin
...
procedure tcyBaseFlowPanel.CMDropFiles(var msg: TWMDropFiles);
begin
  if Assigned(FOnDragDropFiles) then
    FOnDragDropFiles(Self, msg);
end;

procedure tcyBaseFlowPanel.CMMouseEnter(var Msg: TMessage);
begin
  inherited;
  MouseEnter(Self);
end;

procedure tcyBaseFlowPanel.CMMouseLeave(var Msg: TMessage);
begin
  inherited;
  MouseLeave(Self);
end;
