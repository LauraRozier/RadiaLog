...
uses Classes, Windows, SysUtils, Graphics, clipbrd, Messages, ShlObj, ShellAPI;
...
const
  ...
  procedure CopyFilesToClipboard(FromFiles: TStrings);

implementation

// Original CopyFilesToClipboard() source from  http://embarcadero.newsgroups.archived.at/public.delphi.nativeapi/200909/0909212187.html
procedure CopyFilesToClipboard(FromFiles: TStrings);
var
  FileList: String;
