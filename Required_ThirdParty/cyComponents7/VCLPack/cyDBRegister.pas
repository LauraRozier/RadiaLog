...
uses
  ...
  cyDBAdvGrid, cyDBRichEdit,

  // Non visual components
  cyBookmarks, cyFieldLink, cyDatasetCsvExport;
...
begin
  ...
  RegisterComponents(RSVCLDBCompsPalette, [
    ...
    RegisterComponentEditor(TcyDBRichEdit, TcyDefaultEditor);
...
//    RegisterComponentEditor(TcyDBAdvGrid, TcyDefaultEditor);
  ...
  RegisterComponents(RSVCLDBCompsPalette, [
    ...
    RegisterComponentEditor(TcyDatasetCsvExport, TcyDefaultEditor);
end;
