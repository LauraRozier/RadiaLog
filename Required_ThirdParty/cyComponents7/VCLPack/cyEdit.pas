...
uses Classes, Windows, Messages, Controls, StdCtrls, SysUtils, cyStrUtils, Clipbrd;
...
begin
  if CanCallChange then
    if isLoaded then  // We can' t read SelStart when adding component at design time ...
    begin
      CanCallChange := false;
