{   Component(s):
    ...
    Description:
    A FlowPanel with degrade effect
...
uses VCL.cyClasses, cyBaseFlowPanel, Windows, Themes, Graphics, classes, Controls, ExtCtrls, Messages;

type
  TcyCustomFlowPanel = class(TCyBaseFlowPanel)
  private
  ...
  TCyFlowPanel = class(TCyCustomFlowPanel)
  private
  protected
  public
  published
...
//    property ParentColor;
    ...
    // Herited from TcyCustomFlowPanel :
    property Degrade;
  end;

implementation

constructor TcyCustomFlowPanel.Create(AOwner: TComponent);
begin
...
destructor TcyCustomFlowPanel.Destroy;
begin
  FDegrade.Free;
  inherited Destroy;
end;

procedure TcyCustomFlowPanel.SubPropertiesChanged(Sender: TObject);
begin
  Invalidate;
end;

procedure TcyCustomFlowPanel.GradientChanged(Sender: TObject);
begin
...
procedure TcyCustomFlowPanel.Setdegrade(const Value: TcyGradient);
begin
...
procedure TcyCustomFlowPanel.DrawBackground(aRect: TRect);
begin
//  Inherited;
