{   Component(s):
    ...
    Description:
    A GridPanel with degrade effect
...
uses VCL.cyClasses, cyBaseGridPanel, Windows, Themes, Graphics, classes, Controls, ExtCtrls, Messages;

type
  TcyCustomGridPanel = class(TCyBaseGridPanel)
  private
  ...
  TCyGridPanel = class(TCyCustomGridPanel)
  private
  protected
  public
  published
...
//    property ParentColor;
    ...
    // Herited from TcyCustomGridPanel :
    property Degrade;
  end;

implementation

constructor TcyCustomGridPanel.Create(AOwner: TComponent);
begin
...
destructor TcyCustomGridPanel.Destroy;
begin
  FDegrade.Free;
  inherited Destroy;
end;

procedure TcyCustomGridPanel.SubPropertiesChanged(Sender: TObject);
begin
  Invalidate;
end;

procedure TcyCustomGridPanel.GradientChanged(Sender: TObject);
begin
...
procedure TcyCustomGridPanel.Setdegrade(const Value: TcyGradient);
begin
...
procedure TcyCustomGridPanel.DrawBackground(aRect: TRect);
begin
//  Inherited;
