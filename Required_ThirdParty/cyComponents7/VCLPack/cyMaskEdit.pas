...
var
  ...
  // MaskPartMin, MaskPartMax: Integer;
...
begin
  ...
  begin
    ...
    case MaskPartType of
      ...
      begin
// OLD :
//        toPosition := fromPosition + length(MaskPartParamStr) - 1;
//        Rule.AutoInsertChars := MaskPartParamStr;
      ...
      mtMaskPartCustomChars:
        Rule.AllowedChars := MaskPartParamStr;   // Optional char specified by % not handled for now
      ...
      mtOptionalNumbers:                   // Optional number specified by 9 not handled for now
        Rule.AllowedChars := '0123456789';
