...
uses
  ...
  cyFlowPanel, cyGridPanel, cyAdvFlowPanel, cyAdvGridPanel,
  {$ENDIF}
  ...
  cyEdit, cyEditInteger, cyEditFloat, cyEditDate, cyEditTime, cyEditFilename, cyEditMail, cyEditWebsite, cyMaskEdit, cyRadioGroup, cyCheckBox,
