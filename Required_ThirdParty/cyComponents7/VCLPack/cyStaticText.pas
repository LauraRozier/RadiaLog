{   Component(s):
    ...
    Description:
    A StaticText with gradient background, colored border, caption orientation, ellipsis mode, caption layout, wordwrap and glyph/imageList
...
type
  TcyCustomStaticText = class(TcyBaseStaticText)
  private
  ...
  TcyStaticText = class(TcyCustomStaticText)
  private
  protected
  public
  ...
  published
    ...
    // TcyCustomStaticText properties :
    property Degrade;
...
{ TcyCustomStaticText }
constructor TcyCustomStaticText.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TcyCustomStaticText.Destroy;
begin
  FDegrade.Free;
...
procedure TcyCustomStaticText.DegradeChanged(Sender: TObject);
begin
  Invalidate;
end;

procedure TcyCustomStaticText.SetDegrade(const Value: TcyGradient);
begin
  FDegrade := Value;
end;

procedure TcyCustomStaticText.SetImagelistOptions(const Value: TcyImagelistOptions);
begin
  FImagelistOptions.Assign(Value);
end;

procedure TcyCustomStaticText.ImagelistOptionsChanged(Sender: TObject);
begin
  Invalidate;
end;

procedure TcyCustomStaticText.DrawBackground(var Rect: TRect; aState: TButtonState; Hot: Boolean);
begin
  // Draw background :
...
procedure TcyCustomStaticText.DrawStaticText(aState: TButtonState; Hot: Boolean);
var
